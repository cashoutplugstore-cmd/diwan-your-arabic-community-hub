...
export async function fetchMyBlocks(userId: string): Promise<UserBlock[]> {
...
/** Restrictions visible to the current user for a room (own + all when moderator). */
export async function fetchRoomRestrictions(roomId: string): Promise<RoomModeration[]> {
