...
const dialectData: Record<Dialect, { names: string[]; phrases: string[] }> = {
  iraqi: { names: ['زهراء','رُبى','بتول','شهد','كوثر','فرح','حيدر','كرار','مرتضى','سجاد','قاسم','ضرغام','حسين','مهدي','وسام'], phrases: ['شلونكم','شنو رأيكم','هسه','والله','إي والله','خل نسولف','شكو ماكو'] },
  saudi: { names: ['الجوهرة','العنود','مشاعل','غلا','أريام','تالا','راكان','نايف','تركي','وليد','بندر','مشاري','متعب','عبدالعزيز','زياد'], phrases: ['وش علومكم','وش رايكم','يا جماعة','الحين','والله','خلونا نسولف','وش السالفة'] },
  kuwaiti: { names: ['لولوة','حصة','الجود','دانة','شوق','ريما','بدر','مشعل','فيصل','نواف','يعقوب','عبدالرحمن','فهدان','صالح','جابر'], phrases: ['شلونكم','شنو رايكم','يا الربع','الحين','والله','خلنا نسولف','شنو السالفة'] },
  emirati: { names: ['اليازية','شمسة','موزة','مهرة','عوشة','بدور','زايد','سيف','حمدان','راشدون','خليفة','طحنون','سلطان','نهيان','مرشد'], phrases: ['شو الأخبار','شو رايكم','يا جماعة','الحين','والله','خلونا نسولف','شو السالفة'] },
  qatari: { names: ['لولوة','الجوهرة','العنود','مياسة','دانة','حصّة','جاسم','تميم','سعود','مشعل','حمد','فهد','راشد','نواف','غانم'], phrases: ['شخباركم','شنو رايكم','يا الربع','الحين','والله','خلنا نسولف','شنو السالفة'] },
  bahraini: { names: ['حور','زهراء','كوثر','نرجس','أفنان','طيبة','جاسم','باقر','مهدي','عليان','سلمان','يوسفان','هاشم','رضا','صادق'], phrases: ['شخباركم','وش رايكم','يا جماعة','الحين','والله','خلنا نسولف','شنو السالفة'] },
  omani: { names: ['مزون','خولة','أروى','أثير','غالية','مها','حمود','مازن','خميس','بركات','سالمون','هلال','سهيل','سيفان','عدي'], phrases: ['شخباركم','وش رايكم','يا الربع','الحين','والله','خلونا نسولف','شو السالفة'] },
};
