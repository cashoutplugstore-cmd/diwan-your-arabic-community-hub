      ...
      {visible ? (
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-3 px-6 text-center">
            <div
              className="relative grid size-20 place-items-center rounded-[26px] border border-blue-200/25 bg-gradient-to-br from-blue-500/90 via-indigo-500/90 to-slate-800 text-white shadow-[0_0_55px_rgba(59,130,246,.24)] diwan-public-motion"
              style={{ animation: "diwanPublicCore 800ms ease-in-out infinite" }}
            >
              <Hash className="size-9 stroke-[1.8]" />
              <span className="absolute -end-2 -bottom-2 grid size-7 place-items-center rounded-full border border-slate-900/50 bg-slate-900 text-blue-200 shadow-lg">
            ...
            <div>
              <p className="text-[10px] font-bold tracking-[.34em] text-blue-200/70">DIWAN • PUBLIC ROOM</p>
              <h2 className="mt-1 font-display text-lg font-black text-white drop-shadow-lg">جاري دخول الغرفة</h2>
              <p className="mt-1 text-xs text-white/55">لحظة ونكون ويا أهل الديوان ✨</p>
            </div>
          </div>
