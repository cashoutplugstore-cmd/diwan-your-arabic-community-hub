...
export function PremiumPage() {
  ...
  return <div className="diwan-vip-page mx-auto max-w-7xl space-y-6 py-2">
    ...
    <div className="grid gap-5 xl:grid-cols-4 md:grid-cols-2">
      ...
      <PlanCard plan="monthly" title="Monthly" price="€10.99" subtitle="كل شهر" features={monthlyFeatures} icon={<Crown className="size-5" />} featured disabled={pending || active || checkout.isPending} onCheckout={checkout.mutate} />
      <PlanCard plan="four_months" title="4 Months" price="€25.99" subtitle="كل 4 أشهر" features={fourMonthFeatures} icon={<Sparkles className="size-5" />} disabled={pending || active || checkout.isPending} onCheckout={checkout.mutate} />
      <PlanCard plan="yearly" title="Yearly" price="€35.99" subtitle="كل سنة" features={yearlyFeatures} icon={<Crown className="size-5" />} disabled={pending || active || checkout.isPending} onCheckout={checkout.mutate} />
    </div>
