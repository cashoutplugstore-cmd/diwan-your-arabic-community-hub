...
export function PublicProfilePage() {
  ...
  const bot = aiBot ?? (demoMember ? { id: demoMember.id, name: demoMember.display_name || demoMember.username, avatar: "🤖", personality: "عضو آلي من مجتمع ديوان", topics: ["السوالف", "المجتمع", "الدردشة"] } : null);
